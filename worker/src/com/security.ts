...
export async function applySecurityHeaders(c: Context, next: () => Promise<void>) {
  ...
  c.header('Content-Security-Policy', "default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https://imagedelivery.net https://*.imagedelivery.net https://avatars.githubusercontent.com https://images.unsplash.com https://plus.unsplash.com; connect-src 'self'; font-src 'self' data: https://fonts.gstatic.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self' https://github.com")
