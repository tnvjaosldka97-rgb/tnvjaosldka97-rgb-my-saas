...
const FAQS: Faq[] = [
  {
    q: '요금은 어떻게 부과되나요?',
    a: '광고주는 프로젝트 등록 시 노쇼 방지금 1만원만 선결제합니다. 대행사와 계약이 실제 성사되면 등록비는 전액 환불됩니다. 계약이 체결된 경우에 한해, 마케팅천재야가 계약 금액의 10%를 성공 수수료로 받습니다. 대행사는 월정액·수주 수수료 없이 무료로 지원·수주할 수 있습니다.',
  },
  {
